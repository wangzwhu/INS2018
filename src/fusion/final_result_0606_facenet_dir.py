...
def main():
    ...
    # plt.plot(range(gallery_num), scene_similarity[np.argsort(scene_similarity[:, 0]), 0])
    # print(scene_similarity[np.argsort(scene_similarity[:, 0]), 0])
    ...
    for i in range(topics.shape[0]):
        ...
        # final_similarity = temp_person + temp_scene
        ...
        person_similarity_knn_final[person_similarity_knn_final < 423000] = 0
        scene_similarity_knn_final[scene_similarity_knn_final < 423000] = 0
