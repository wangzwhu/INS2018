...
def main():
    ...
    scene_threshold_list  = [600,  800,  1000, 1200, 1400, 1800, 1800, 1800, 1800, 2000, 2200, 2400, 2800, 3000, 3200, 3400, 3600, 3800, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4200, 4400, 4600, 4800, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5500, 6000, 6500, 7000, 7000, 7000, 7000, 7000, 7000, 7000,   7000,  7000,  7000,  7000,  8000,  9000, 10000, 11000, 12000, 13000, 14000, 15000, 16000, 17000, 18000, 19000]
    person_threshold_list = [2000, 2000, 2000, 2000, 2100, 2200, 2300, 2400, 2500, 2600, 2700, 2800, 2900, 3000, 3100, 3100, 3100, 3100, 3100, 3200, 3300, 3400, 3500, 3600, 3700, 3800, 3900, 4000, 4200, 4400, 4600, 4800, 5000, 5000, 5000, 5000, 5000, 5300, 5600, 6000, 6400, 6800, 7200, 7200, 7200, 7200, 7200, 7600, 8000, 8500, 9000, 9500, 10000, 11000, 12000, 13000, 14000, 14000, 14000, 14000, 14000, 15000, 16000, 17000, 18000, 19000, 20000, 21000, 22000]
    for k in range(69):
        # score adjust
        time_knn = 6
        ...
        for i in range(topics.shape[0]):
            ...
            final_similarity = 0.6*temp_person + 0.2*temp_scene + 0.1*temp_person_knn + 0.1*temp_scene_knn
    ...
    final_similarity_result_file_path = '/net/dl380g7a/export/ddn11c1/wangz/ins2018/result/final_similarity_result_a3.npy'
