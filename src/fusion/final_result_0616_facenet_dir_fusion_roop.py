...
def main():
    ...
    run_id = '0616_facenet_dir_fusion_mutual_roop'
    query_id = 'shot1_1'
    ...
    scene_threshold_list  = [1000, 1500, 2000, 2500, 3000, 3500, 4000, 4000, 4000, 4000, 4500, 4500, 5000, 5000, 5000, 5500, 6000, 6500, 7000, 7000, 8000, 9000,  10000, 11000, 11500, 12000, 12500, 13000, 14000, 15000]
    person_threshold_list = [2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 6500, 6500, 7000, 7000, 7500, 8000, 8000, 8000, 8000, 8000, 9000, 9000, 10000, 11000, 12000, 13000, 14000, 15000, 16000, 18000, 20000]
    for k in range(30):
        # score adjust
        time_knn = 3
